...
def prompt_payment():
    try:
        quarter = int(input("How many quarters you want to insert: "))
    except ValueError:
        quarter = 0
    try:
        dime = int(input("How many dimes you want to insert: "))
    except ValueError:
        dime = 0
    try:
        nickel = int(input("How many nickels you want to insert: "))
    except ValueError:
        nickel = 0
    try:
